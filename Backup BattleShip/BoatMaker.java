...
public class BoatMaker {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BoatMaker window = new BoatMaker(2);
	...
	public BoatMaker(int playerNum) {
		gUIPlayerNumber = playerNum;
		initialize();
	}
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 683, 360);
		...
		frame.getContentPane().add(lblSetYourShips);
